...
export const topDestination = [
	...
	{
		image: 'https://f1e425bd6cd9ac6.cmccloud.com.vn/cms-tool/destination/images/27/img_hero.png',
		title: 'Đà Nẵng - Huế',
		price: '180.000đ',
		bgColor: 'bg-teal-500',
	},
...
export const searchCar = [
	{
		...
		journeyDetails: 'Vé chặng thuộc chuyến 12:00 31-10-2024 Sài Gòn - Quảng Ngãi',
...
Quý khách vui lòng liên hệ tổng đài VeXeRe để được hỗ trợ bảng giá cước gửi xe và xác nhận còn chỗ trống để gửi kèm xe (trong trường hợp nhà xe không còn hầm trống sẽ không hỗ trợ nhận gửi kèm xe đạp/xe máy)`,
	},
	{
		...
		ratingCount: '222',
		busImage:
			'https://cf.bstatic.com/xdata/images/hotel/square600/607295906.webp?k=a99dd6f2dc93953a9a3066828033fae04ace3e7ea6e26fea44e3e1a7e7002195&o=',
		busId: 2,
		price: '500000',
